...
foreach(removed_experiment suite_qhpc suite_libfabric suite_samples)
	if(EXISTS "${DEFW_INSTALL_PREFIX}/python/experiments/${removed_experiment}")
		message(FATAL_ERROR
			"DEFw install contains retired experiment ${removed_experiment}")
	endif()
endforeach()
